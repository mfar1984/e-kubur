    ...
    <main class="flex-1">
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <div class="mb-6">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Rekod Kematian</h1>
                        <p class="text-xs text-gray-600">Tambah rekod kematian baru ke dalam sistem</p>
                    </div>
                </div>

                <!-- Form -->
                <form method="POST" action="{{ route('kematian.store') }}" class="space-y-8">
                    @csrf
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" id="tarikh_lahir" name="tarikh_lahir" value="{{ old('tarikh_lahir') }}" required
                            ...
                            <div>
                                ...
                                <input type="date" id="tarikh_meninggal" name="tarikh_meninggal" value="{{ old('tarikh_meninggal') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="longitude" name="longitude" value="{{ old('longitude', \App\Models\Tetapan::getDefaultLongitude()) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="latitude" name="latitude" value="{{ old('latitude', \App\Models\Tetapan::getDefaultLatitude()) }}" required
                            ...
                            <div class="map-controls mb-3">
                                ...
                                <div class="hidden md:flex items-center justify-between">
                                    ...
                                    <div class="coordinate-display" id="coordinate-display">
                                        Lat: {{ number_format(\App\Models\Tetapan::getDefaultLatitude(), 6) }}, Lng: {{ number_format(\App\Models\Tetapan::getDefaultLongitude(), 6) }}
                                    </div>
                                </div>
                    ...
                    <div class="bg-green-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="waris" name="waris" value="{{ old('waris') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="telefon_waris" name="telefon_waris" value="{{ old('telefon_waris') }}" required
                    ...
                    <!-- Catatan & Lampiran -->
                    <div class="bg-white shadow-lg border border-gray-200 p-6 mb-6" x-data="attachmentsForm()">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea id="catatan" name="catatan" rows="3" class="w-full px-3 py-2 border-b-2 border-gray-300 text-xs focus:border-b-2 focus:border-blue-500 focus:outline-none placeholder-gray-500 text-gray-900" placeholder="Masukkan catatan tambahan (jika ada)">{{ old('catatan') }}</textarea>
                            </div>

                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-2">Lampiran Gambar</label>
                                <div class="flex items-center space-x-2 mb-3">
                                    <input type="file" accept="image/*" capture="environment" @change="onCapture($event)" class="hidden" id="capture-input">
                                ...
                                <div class="flex flex-wrap gap-2 items-start" id="preview-grid">
                                    <!-- previews via Alpine -->
                                    <template x-for="(img, idx) in images" :key="img.id">
                                        <div class="relative group flex items-start justify-start">
                                            <img :src="img.url" class="w-16 h-16 object-cover rounded-md border border-gray-200" alt="preview">
                                            <button type="button" @click="remove(idx)" class="absolute top-1 right-1 text-red-500 hover:text-red-600 text-md font-bold">
                                                ×
                                            </button>
                                        </div>
                                    </template>
...
function attachmentsForm(){
    return {
        images: [],
        onCapture(e){ this.handleFiles(e.target.files); e.target.value=''; },
        onSelect(e){ this.handleFiles(e.target.files); e.target.value=''; },
        handleFiles(fileList){
            Array.from(fileList || []).forEach(file => {
                const url = URL.createObjectURL(file);
                this.images.push({ id: Date.now()+Math.random(), file, url });
                
                // Create hidden inputs to submit files
        ...
        remove(idx){
            ...
            this.$nextTick(() => {
                ...
                document.querySelectorAll('input[name="attachments[]"]').forEach(el => el.remove());
                
                // Recreate hidden inputs for remaining images
