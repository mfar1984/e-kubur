    ...
    <main class="flex-1">
        <div class="container mx-auto px-0 py-0">
            ...
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="text-xl font-bold text-gray-900 mb-1">Edit Pengguna Akses</h1>
                    <p class="text-xs text-gray-600">Kemaskini maklumat pengguna dan kumpulan akses</p>
                </div>

                <!-- Form -->
                <form action="{{ route('user-access.update', $userAccess) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="name" 
                                       name="name" 
                                       value="{{ old('name', $userAccess->name) }}"
                            ...
                            <div>
                                ...
                                <input type="email" 
                                       id="email" 
                                       name="email" 
                                       value="{{ old('email', $userAccess->email) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-xs text-xs text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="phone" 
                                       name="phone" 
                                       value="{{ old('phone', $userAccess->phone) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-xs text-xs text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <!-- Password -->
                            <div>
                                <label for="password" class="block text-xs font-medium text-gray-700 mb-2">Kata Laluan Baru</label>
                                <input type="password" 
                                       id="password" 
                                       name="password" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-xs text-xs text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <div>
                                <label for="password_confirmation" class="block text-xs font-medium text-gray-700 mb-2">Sahkan Kata Laluan Baru</label>
                                <input type="password" 
